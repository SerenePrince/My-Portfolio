function Projects() {
  return (
    <div className="projects-container" id="projects">
      <h1>Projects</h1>
      <a
        href="https://github.com/SerenePrince/Battleship-Game"
        target="_blank"
      ...
      <p>
        To be honest, this one&apos;s a bit rough. It was my first big project,
        and it barely works. But hey, I&apos;m putting it here to show my
        progress. It&apos;s nice to look back and see how far I&apos;ve come.
      </p>
      <div className="projects-content-row">
        ...
        <img
          className="battleship-game-image"
          src="./assets/images/battleship-game-project.png"
          alt="An image of the battleship game."
        />
      </div>
      <a
        href="https://github.com/SerenePrince/Typing-Test"
        target="_blank"
        rel="noopener noreferrer"
      >
        <h2>Typing Test</h2>
      ...
      <div className="projects-content-row reverse">
        <ul>
          <li>
            Random Word List: The application generates a new list of 50 random
            words each time you start the test.
          </li>
          <li>
        ...
        <img
          className="typing-test-image"
          src="./assets/images/typing-test-project.png"
          alt="An image of the typing test program."
        />
      </div>
      <a
      ...
      <p>
        Now here&apos;s one I&apos;m genuinely excited to share. It was my first
        time using Python, and I think I did pretty well all things considered.
        I&apos;ll definitely keep coming back to this one to add more features.
      </p>
      <div className="projects-content-row">
        <ul>
          <li>
        ...
        <img
          ...
          alt="An image of the weather app program."
        />
      </div>
      <a
      ...
      <p>
        ...
        charm and has some nice visuals. Pretty proud of this one. Try it out it
        by clicking{" "}
        <a
      ...
      <div className="projects-content-row reverse">
        <ul>
          ...
          <li>
            Game Restart: After completing a game, users can refresh the page to
            try a new word.
          </li>
          <li>
            Customizable Background: Potential for dynamic background images
        ...
        <img
          className="wordle-clone-image"
          src="./assets/images/wordle-clone-project.png"
          alt="An image of the Wordle clone program."
        />
      </div>
    </div>
  );
